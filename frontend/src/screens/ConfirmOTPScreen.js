    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.text}>
                Quý khách vui lòng nhập mã OTP đã được gửi qua email {user?.email || email}
            </Text>
            <Input placeholder="Nhập OTP" value={otp} onChangeText={(text) => setOtp(text)} />
            <Button type="otp" onPress={handleClick}>
                Xác nhận
            </Button>
        </View>
    )
